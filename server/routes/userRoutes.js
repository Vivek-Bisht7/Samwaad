...
const {registerUser,loginUser,handleRefreshToken,handleLogout,getCurrentUser,searchUser,updateProfile,getUserDetails} = require('../controllers/userControllers');
